...
We then create tables of our results, using the `mean_report_metrics()` function
...
We use the `knitr::kable()` functionality, as well as the `kableExtra` package, to export our results into a format suitable for our report. This is contained within the `read_table()` function.
